...
class TrelloMapperTest {
    ...
    void mapToBoards() {
        //Given
        List<TrelloBoardDto> trelloBoardsDto = setupTrelloBoardsDto();
    ...
    void mapToBoardsDto() {
        //Given
        List<TrelloBoard> trelloBoards = setupTrelloBoards();
    ...
    private List<TrelloBoardDto> setupTrelloBoardsDto() {
    ...
    private List<TrelloBoard> setupTrelloBoards() {
